        ...
        >
          <Box sx={{ width: { xs: '100%', sm: '90%' } }}>
            ...
            <Typography variant="body2" sx={{ color: 'text.secondary', mb: 2 }}>
                Unless otherwise specified, the information contained on this site is Sophkos Ltd copyright. Sophkos website, APIs, SDKs, and mobile applications content and materials are protected.
              ...
              <Link href="./PrivacyPolicy.pdf" target={"_blank"}>Privacy Policy</Link>
          </Box>
        </Box>
